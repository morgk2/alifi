  ...
  void dispose() {
    ...
    try {
      ...
      if (currentUser != null && currentUser.id.isNotEmpty && widget.storeUser.id.isNotEmpty && product.id.isNotEmpty) {
        ...
        final message = AppLocalizations.of(context)!.iWouldLikeToOrder(product.name.isNotEmpty ? product.name : AppLocalizations.of(context)!.product, '\$${product.price.toStringAsFixed(2)}');
        final productImageUrl = product.imageUrls.isNotEmpty ? product.imageUrls.first : '';
        final productName = product.name.isNotEmpty ? product.name : AppLocalizations.of(context)!.product;
        ...
        final order = store_order.StoreOrder(
          ...
          customerName: currentUser.displayName?.isNotEmpty == true ? currentUser.displayName! : AppLocalizations.of(context)!.anonymous,
          storeId: widget.storeUser.id,
          storeName: widget.storeUser.displayName?.isNotEmpty == true ? widget.storeUser.displayName! : AppLocalizations.of(context)!.store,
          productId: product.id,
          productName: productName,
          productImageUrl: productImageUrl,
          price: product.price,
