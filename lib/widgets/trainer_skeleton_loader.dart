...
class TrainerSkeletonLoader extends StatelessWidget {
  const TrainerSkeletonLoader({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          ...List.generate(4, (index) => _buildTrainerServiceCardSkeleton()),
  ...
  Widget _buildTrainerServiceCardSkeleton() {
    return Container(
